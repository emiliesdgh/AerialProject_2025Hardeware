...
if __name__ == "__main__":
    ...
    start = np.array([75, 25, 0, 0])
    end = np.array([75, 25, 0, 0])
    gate1 = np.array([100, 50, 0, 45, 0])
    gate2 = np.array([100, 100, 0, 135, 0])
    gate3 = np.array([50, 100, 0, 225, 0])
    gate4 = np.array([50, 50, 0, 315, 0])
