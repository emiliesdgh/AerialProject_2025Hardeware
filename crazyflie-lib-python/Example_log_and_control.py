...
if __name__ == '__main__':
    ...
    while le.is_connected:
        ...
        # Take-off
        for y in range(10):
            cf.commander.send_hover_setpoint(0, 0, 0,0)# y / 25)
            time.sleep(0.1)
        for _ in range(20):
        ...
        # 🔼 Avancer (x positif)
        for _ in range(15):
            cf.commander.send_hover_setpoint(0.2, 0, 0, 0.4)
            print("Avancer")
            time.sleep(0.1)
        ...
        # > Bouge à gauche (y positif)
        for _ in range(20):
            cf.commander.send_hover_setpoint(0, 0.2, 0, 0.4)
